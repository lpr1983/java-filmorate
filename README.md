...
В этом проекте реализована база данных для хранения информации о фильмах, пользователях, жанрах, рейтингах, дружбе и
лайках.
...
- **reviews_likes** — Лайки пользователей на отзывы
- **directors** - Режиссеры.
- **film_directors** - Режиссеры фильмов.
- **user_feeds** - События пользователя.
